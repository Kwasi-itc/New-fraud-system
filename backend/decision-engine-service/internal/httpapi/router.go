...
func NewRouter(logger *slog.Logger, db *pgxpool.Pool, cfg RouterConfig) *gin.Engine {
	...
	testRunService := service.NewTestRunService(txManager, uuidGenerator{}, systemClock{}, scenarioRepo, iterationRepo, ruleRepo, testRunRepo, phantomDecisionRepo, phantomRuleExecRepo)
	...
	executionService := service.NewExecutionService(txManager, uuidGenerator{}, systemClock{}, scenarioRepo, tenantDataReader, scheduledExecutionRepo, asyncDecisionExecutionRepo, decisionService)
