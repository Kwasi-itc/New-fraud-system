...
func SupportedFunctionCatalog() []FunctionDescriptor {
	return []FunctionDescriptor{
		...
		{Name: "IsNotInList", Category: "marble compatibility", Description: "Returns true when the left value does not exist inside the right list.", ReturnType: domainast.ValueTypeBool, PositionalArity: intPtr(2), Example: `{"name":"IsNotInList","children":[{"constant":"review"},{"name":"List","children":[{"constant":"approve"},{"constant":"decline"}]}]}`},
